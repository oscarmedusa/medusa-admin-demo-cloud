...
__decorate([
    (0, core_1.Formula)((item) => `(SELECT SUM(reserved_quantity) FROM inventory_level il WHERE il.inventory_item_id = ${item}.id AND il.deleted_at IS NULL)`, { lazy: true, serializer: Number, hidden: true }),
    __metadata("design:type", Number)
], InventoryItem.prototype, "reserved_quantity", void 0);
__decorate([
    (0, core_1.Formula)((item) => `(SELECT SUM(stocked_quantity) FROM inventory_level il WHERE il.inventory_item_id = ${item}.id AND il.deleted_at IS NULL)`, { lazy: true, serializer: Number, hidden: true }),
    __metadata("design:type", Number)
