...
let InventoryLevel = class InventoryLevel {
    ...
    beforeCreate() {
        this.id = (0, utils_2.generateEntityId)(this.id, "ilev");
    ...
    onLoad() {
        if ((0, utils_1.isDefined)(this.stocked_quantity) && (0, utils_1.isDefined)(this.reserved_quantity)) {
            this.available_quantity = new utils_2.BigNumber(utils_1.MathBN.sub(this.raw_stocked_quantity, this.raw_reserved_quantity));
        }
    }
};
...
__decorate([
    (0, utils_2.MikroOrmBigNumberProperty)(),
    __metadata("design:type", Object)
], InventoryLevel.prototype, "stocked_quantity", void 0);
__decorate([
    (0, core_1.Property)({ columnType: "jsonb" }),
    __metadata("design:type", Object)
], InventoryLevel.prototype, "raw_stocked_quantity", void 0);
__decorate([
    (0, utils_2.MikroOrmBigNumberProperty)(),
    __metadata("design:type", Object)
...
__decorate([
    (0, core_1.Property)({ columnType: "jsonb" }),
    __metadata("design:type", Object)
], InventoryLevel.prototype, "raw_reserved_quantity", void 0);
__decorate([
    (0, utils_2.MikroOrmBigNumberProperty)(),
    __metadata("design:type", Object)
...
__decorate([
    (0, core_1.Property)({ columnType: "jsonb" }),
    __metadata("design:type", Object)
], InventoryLevel.prototype, "raw_incoming_quantity", void 0);
__decorate([
