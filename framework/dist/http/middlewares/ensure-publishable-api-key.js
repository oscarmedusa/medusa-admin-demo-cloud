...
async function ensurePublishableApiKeyMiddleware(req, _res, next) {
    ...
    if (!(0, utils_1.isPresent)(publishableApiKey)) {
        try {
            throw new utils_1.MedusaError(utils_1.MedusaError.Types.NOT_ALLOWED, `Publishable API key required in the request header: ${utils_1.PUBLISHABLE_KEY_HEADER}. You can manage your keys in settings in the dashboard.`);
        }
        catch (e) {
            return next(e);
        }
