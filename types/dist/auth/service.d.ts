...
import { AuthenticationInput, AuthenticationResponse, AuthIdentityDTO, CreateAuthIdentityDTO, CreateProviderIdentityDTO, FilterableAuthIdentityProps, FilterableProviderIdentityProps, ProviderIdentityDTO, UpdateAuthIdentityDTO, UpdateProviderIdentityDTO } from "./common";
/**
...
export interface IAuthModuleService extends IModuleService {
     ...
     */
    retrieveAuthIdentity(id: string, config?: FindConfig<AuthIdentityDTO>, sharedContext?: Context): Promise<AuthIdentityDTO>;
    /**
     ...
     * ```
     */
    listAuthIdentities(filters?: FilterableAuthIdentityProps, config?: FindConfig<AuthIdentityDTO>, sharedContext?: Context): Promise<AuthIdentityDTO[]>;
    /**
     ...
     * ```
     */
    listAndCountAuthIdentities(filters?: FilterableAuthIdentityProps, config?: FindConfig<AuthIdentityDTO>, sharedContext?: Context): Promise<[AuthIdentityDTO[], number]>;
    /**
     ...
     * ])
     */
    createAuthIdentities(data: CreateAuthIdentityDTO[], sharedContext?: Context): Promise<AuthIdentityDTO[]>;
    /**
     ...
     * ])
     */
    updateAuthIdentities(data: UpdateAuthIdentityDTO[], sharedContext?: Context): Promise<AuthIdentityDTO[]>;
    /**
     ...
     */
    retrieveProviderIdentity(id: string, config?: FindConfig<ProviderIdentityDTO>, sharedContext?: Context): Promise<ProviderIdentityDTO>;
    /**
     ...
     * ```
     */
    listProviderIdentities(filters?: FilterableProviderIdentityProps, config?: FindConfig<ProviderIdentityDTO>, sharedContext?: Context): Promise<ProviderIdentityDTO[]>;
    /**
     ...
     * ])
     */
    createProviderIdentities(data: CreateProviderIdentityDTO[], sharedContext?: Context): Promise<ProviderIdentityDTO[]>;
    /**
     ...
     * ])
     */
    updateProviderIdentities(data: UpdateProviderIdentityDTO[], sharedContext?: Context): Promise<ProviderIdentityDTO[]>;
    /**
     ...
     */
    deleteProviderIdentities(ids: string[], sharedContext?: Context): Promise<void>;
}
