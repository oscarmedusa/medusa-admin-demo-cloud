...
import { BaseFilterable, FilterQuery as InternalFilterQuery, FilterQuery, PerformedActions, UpsertWithReplaceConfig } from "../dal";
import { InferEntityType } from "../dml";
export interface IMedusaInternalService<TEntity extends {}, TContainer extends object = object> {
    get __container__(): TContainer;
    retrieve(idOrObject: string, config?: FindConfig<any>, sharedContext?: Context): Promise<InferEntityType<TEntity>>;
    retrieve(idOrObject: object, config?: FindConfig<any>, sharedContext?: Context): Promise<InferEntityType<TEntity>>;
    list(filters?: FilterQuery<any> | BaseFilterable<FilterQuery<any>>, config?: FindConfig<any>, sharedContext?: Context): Promise<InferEntityType<TEntity>[]>;
    listAndCount(filters?: FilterQuery<any> | BaseFilterable<FilterQuery<any>>, config?: FindConfig<any>, sharedContext?: Context): Promise<[InferEntityType<TEntity>[], number]>;
    ...
    upsert(data: any, sharedContext?: Context): Promise<InferEntityType<TEntity>>;
    upsertWithReplace(data: any[], config?: UpsertWithReplaceConfig<InferEntityType<TEntity>>, sharedContext?: Context): Promise<{
