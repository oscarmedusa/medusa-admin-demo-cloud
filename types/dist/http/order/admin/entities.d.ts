...
import { BaseOrder, BaseOrderAddress, BaseOrderChange, BaseOrderChangeAction, BaseOrderFulfillment, BaseOrderLineItem, BaseOrderShippingMethod } from "../common";
...
export interface AdminOrderChange extends Omit<BaseOrderChange, "order" | "claim" | "return_order" | "exchange" | "actions"> {
    order: AdminOrder;
    claim: AdminClaim;
...
export interface AdminOrderPreview extends Omit<AdminOrder, "items" | "shipping_methods"> {
