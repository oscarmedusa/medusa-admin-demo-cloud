...
export interface BaseCustomerFilters extends FindParams, BaseFilterable<BaseCustomerFilters> {
    q?: string;
...
export interface BaseCustomerAddressFilters extends BaseFilterable<BaseCustomerAddressFilters> {
    q?: string;
