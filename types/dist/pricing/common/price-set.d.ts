...
import { CreateMoneyAmountDTO, FilterableMoneyAmountProps, MoneyAmountDTO, UpdateMoneyAmountDTO } from "./money-amount";
 ...
 */
export interface FilterablePriceSetProps extends BaseFilterable<FilterablePriceSetProps>, PricingContext {
    /**
