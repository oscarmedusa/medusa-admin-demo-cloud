...
export interface ICartModuleService extends IModuleService {
     ...
     * ```
     */
    retrieveCart(cartId: string, config?: FindConfig<CartDTO>, sharedContext?: Context): Promise<CartDTO>;
    /**
     ...
     * ```
     */
    listCarts(filters?: FilterableCartProps, config?: FindConfig<CartDTO>, sharedContext?: Context): Promise<CartDTO[]>;
    /**
     ...
     * ```
     */
    listAndCountCarts(filters?: FilterableCartProps, config?: FindConfig<CartDTO>, sharedContext?: Context): Promise<[CartDTO[], number]>;
    /**
     ...
     * })
     */
    updateCarts(cartId: string, data: UpdateCartDataDTO, sharedContext?: Context): Promise<CartDTO>;
    /**
     ...
     * )
     */
    updateCarts(selector: Partial<CartDTO>, data: UpdateCartDataDTO, sharedContext?: Context): Promise<CartDTO[]>;
    /**
     ...
     */
    softDeleteCarts<TReturnableLinkableKeys extends string = string>(ids: string[], config?: SoftDeleteReturn<TReturnableLinkableKeys>, sharedContext?: Context): Promise<Record<TReturnableLinkableKeys, string[]> | void>;
    /**
     ...
     */
    restoreCarts<TReturnableLinkableKeys extends string = string>(ids: string[], config?: RestoreReturn<TReturnableLinkableKeys>, sharedContext?: Context): Promise<Record<TReturnableLinkableKeys, string[]> | void>;
    /**
