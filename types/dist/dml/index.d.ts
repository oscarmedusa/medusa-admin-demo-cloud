...
export type InferForeignKeys<Schema extends DMLSchema> = {
    [K in keyof Schema as Schema[K] extends {
        type: infer Type;
    } ? Type extends RelationshipTypes ? `${K & string}_id` : never : never]: Schema[K] extends {
        type: infer Type;
    } ? Type extends RelationshipTypes ? string : never : never;
};
/**
 ...
 */
export type InferIndexableProperties<T> = keyof (T extends IDmlEntity<infer Schema, any> ? {
    [K in keyof Schema as Schema[K] extends {
        type: infer Type;
    } ? Type extends RelationshipTypes ? never : K : K]: string;
} & InferForeignKeys<Schema> : never);
