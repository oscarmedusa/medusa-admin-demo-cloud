...
const middlewares_55 = require("./store/regions/middlewares");
const middlewares_56 = require("./store/return-reasons/middlewares");
const middlewares_57 = require("./store/shipping-options/middlewares");
exports.default = (0, define_middlewares_1.defineMiddlewares)([
    ...
    ...middlewares_57.storeShippingOptionRoutesMiddlewares,
    ...
    ...middlewares_55.storeRegionRoutesMiddlewares,
    ...
    ...middlewares_56.storeReturnReasonRoutesMiddlewares,
