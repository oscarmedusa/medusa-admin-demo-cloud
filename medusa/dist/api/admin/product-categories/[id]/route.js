...
const GET = async (req, res) => {
    const [category] = await (0, http_1.refetchEntities)("product_category", { id: req.params.id, ...req.filterableFields }, req.scope, req.remoteQueryConfig.fields);
    if (!category) {
...
const POST = async (req, res) => {
    ...
    const [category] = await (0, http_1.refetchEntities)("product_category", { id, ...req.filterableFields }, req.scope, req.remoteQueryConfig.fields);
