...
const GET = async (req, res) => {
    const shippingOption = await (0, helpers_1.refetchShippingOption)(req.params.id, req.scope, req.remoteQueryConfig.fields);
    if (!shippingOption) {
...
const POST = async (req, res) => {
    ...
    const shippingOption = await (0, helpers_1.refetchShippingOption)(result[0].id, req.scope, req.remoteQueryConfig.fields);
