...
exports.adminPromotionRoutesMiddlewares = [
    ...
    },
    {
        ...
        middlewares: [
            (0, http_1.unlessPath)(/.*\/promotions\/rule-attribute-options/, (0, framework_1.validateAndTransformQuery)(validators_2.AdminGetPromotionRuleTypeParams, QueryConfig.retrieveTransformQueryConfig)),
        ],
    },
    {
        method: ["POST"],
