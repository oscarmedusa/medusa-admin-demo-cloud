...
const GET = async (req, res) => {
    const productType = await (0, helpers_1.refetchProductType)(req.params.id, req.scope, req.remoteQueryConfig.fields);
...
const POST = async (req, res) => {
    ...
    const productType = await (0, helpers_1.refetchProductType)(result[0].id, req.scope, req.remoteQueryConfig.fields);
    res.status(200).json({ product_type: productType });
};
exports.POST = POST;
