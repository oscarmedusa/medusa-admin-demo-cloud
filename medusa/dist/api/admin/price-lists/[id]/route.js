...
const GET = async (req, res) => {
    const price_list = await (0, helpers_1.fetchPriceList)(req.params.id, req.scope, req.remoteQueryConfig.fields);
...
const POST = async (req, res) => {
    ...
    const price_list = await (0, helpers_1.fetchPriceList)(id, req.scope, req.remoteQueryConfig.fields);
    res.status(200).json({ price_list });
};
exports.POST = POST;
