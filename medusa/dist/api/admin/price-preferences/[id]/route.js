...
const GET = async (req, res) => {
    const price_preference = await (0, http_1.refetchEntity)("price_preference", req.params.id, req.scope, req.remoteQueryConfig.fields);
...
const POST = async (req, res) => {
    ...
    const price_preference = await (0, http_1.refetchEntity)("price_preference", id, req.scope, req.remoteQueryConfig.fields);
    res.status(200).json({ price_preference });
};
exports.POST = POST;
