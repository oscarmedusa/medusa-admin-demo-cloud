...
const POST = async (req, res) => {
    ...
    const variant = await (0, helpers_1.refetchVariant)(variantId, req.scope, req.remoteQueryConfig.fields);
...
const DELETE = async (req, res) => {
    ...
    const parent = await (0, helpers_1.refetchVariant)(variantId, req.scope, req.remoteQueryConfig.fields);
    res.status(200).json({
        id: deleted,
