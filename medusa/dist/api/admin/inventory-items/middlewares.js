...
exports.adminInventoryRoutesMiddlewares = [
    ...
    },
    {
        ...
        middlewares: [
            (0, framework_1.validateAndTransformBody)((0, validators_2.createBatchBody)(validators_1.AdminCreateInventoryLocationLevel, validators_1.AdminUpdateInventoryLocationLevel)),
    ...
    },
    {
        ...
        middlewares: [
            (0, http_1.unlessPath)(/.*\/location-levels\/batch/, (0, framework_1.validateAndTransformQuery)(validators_1.AdminGetInventoryItemParams, QueryConfig.retrieveTransformQueryConfig)),
        ],
    },
    {
        method: ["POST"],
        matcher: "/admin/inventory-items/:id/location-levels/:location_id",
        middlewares: [
            (0, http_1.unlessPath)(/.*\/location-levels\/batch/, (0, framework_1.validateAndTransformBody)(validators_1.AdminUpdateInventoryLocationLevel)),
            (0, http_1.unlessPath)(/.*\/location-levels\/batch/, (0, framework_1.validateAndTransformQuery)(validators_1.AdminGetInventoryItemParams, QueryConfig.retrieveTransformQueryConfig)),
        ],
    },
];
