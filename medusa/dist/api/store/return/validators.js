...
exports.StorePostReturnsReqSchema = exports.ReturnsParams = exports.ReturnParams = void 0;
const zod_1 = require("zod");
const validators_1 = require("../../utils/validators");
exports.ReturnParams = (0, validators_1.createSelectParams)();
exports.ReturnsParams = (0, validators_1.createFindParams)().merge(zod_1.z.object({
    id: zod_1.z.union([zod_1.z.string(), zod_1.z.array(zod_1.z.string())]).optional(),
    order_id: zod_1.z.union([zod_1.z.string(), zod_1.z.array(zod_1.z.string())]).optional(),
    $and: zod_1.z.lazy(() => exports.ReturnsParams.array()).optional(),
    $or: zod_1.z.lazy(() => exports.ReturnsParams.array()).optional(),
}));
