 ...
 */
export declare const WithAdditionalData: <T extends ZodObject<any, any>>(originalSchema: T, modifyCallback?: (schema: T) => ZodObject<any, any> | ZodEffects<any, any>) => (additionalDataValidator?: ZodObject<any, any>) => z.ZodObject<any, any, z.ZodTypeAny, {
    [x: string]: any;
}, {
    [x: string]: any;
