import { DAL, InferEntityType, NotificationTypes } from "@medusajs/framework/types";
...
declare const NotificationProviderService_base: new (container: InjectedDependencies) => import("@medusajs/framework/types").IMedusaInternalService<import("@medusajs/framework/utils").DmlEntity<{
...
} & {} & import("@medusajs/framework/utils").DMLSchemaDefaults, "notificationProvider">, InjectedDependencies>;
