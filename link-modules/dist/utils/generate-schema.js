...
function generateGraphQLSchema(joinerConfig, primary, foreign, { logger } = { logger: console }) {
    ...
    const primaryField = doesPrimaryExportSchema
        ? `${(0, utils_1.camelToSnakeCase)(primary.alias)}: ${(0, utils_1.toPascalCase)((0, utils_1.composeTableName)(primary.serviceName))}`
        : "";
    const foreignField = doesForeignExportSchema
        ? `${(0, utils_1.camelToSnakeCase)(foreign.alias)}: ${(0, utils_1.toPascalCase)((0, utils_1.composeTableName)(foreign.serviceName))}`
        : "";
    typeDef += `
    type ${entityName} {
