import { IEventBusModuleService, Logger, ProductTypes } from "@medusajs/framework/types";
...
export declare enum ProductCategoryEvents {
...
export declare enum ProductCollectionEvents {
...
export type CreateProductCollection = ProductTypes.CreateProductCollectionDTO & {
    products?: string[];
};
