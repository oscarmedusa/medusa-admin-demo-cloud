...
const calender_1 = require("../calender");
...
const DatePicker = React.forwardRef(({ size = "base", shouldCloseOnSelect = true, className, ...props }, ref) => {
    const [value, setValue] = React.useState((0, calendar_1.getDefaultCalendarDateFromDate)(props.value, props.defaultValue, props.granularity));
    ...
    React.useEffect(() => {
        setValue(props.value ? (0, calendar_1.updateCalendarDateFromDate)(value, props.value, props.granularity) : null);
        state.setValue(props.value ? (0, calendar_1.updateCalendarDateFromDate)(value, props.value, props.granularity) : null);
    }, [props.value]);
    function clear(e) {
        var _a;
        e.preventDefault();
    ...
    return (React.createElement(popover_1.Popover, { open: state.isOpen, onOpenChange: state.setOpen },
        ...
        React.createElement(popover_1.Popover.Content, { ref: contentRef, ...dialogProps, className: "flex flex-col divide-y p-0" },
            React.createElement("div", { className: "p-3" },
                React.createElement(calender_1.InternalCalendar, { autoFocus: true, ...calendarProps })),
...
function convertProps(props, setValue) {
    ...
    return {
        ...
        onChange: onChange,
        isDateUnavailable,
        minValue: minValue ? (0, calendar_1.createCalendarDateFromDate)(minValue, props.granularity) : minValue,
        maxValue: maxValue ? (0, calendar_1.createCalendarDateFromDate)(maxValue, props.granularity) : maxValue,
    };
}
