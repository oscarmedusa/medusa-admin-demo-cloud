...
export declare class EntityBuilder {
     ...
     */
    define<Schema extends DMLSchema, const TConfig extends IDmlEntityConfig>(nameOrConfig: TConfig, schema: Schema): DmlEntity<Schema & DMLSchemaWithBigNumber<Schema> & DMLSchemaDefaults, TConfig>;
    /**
     ...
     */
    hasOne<T>(entityBuilder: T, options?: RelationshipOptions): HasOne<T>;
    /**
     ...
     * @customNamespace Relationship Methods
     */
    belongsTo<T>(entityBuilder: T, options?: RelationshipOptions): BelongsTo<T>;
    /**
     * This method defines a relationship between two data models,
