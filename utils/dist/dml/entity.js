...
var _DmlEntity_tableName, _DmlEntity_cascades, _DmlEntity_indexes, _a;
...
function extractNameAndTableName(nameOrConfig) {
    ...
    if ((0, common_1.isString)(nameOrConfig)) {
        ...
        result.name = (0, common_1.toCamelCase)(name);
...
_DmlEntity_tableName = new WeakMap(), _DmlEntity_cascades = new WeakMap(), _DmlEntity_indexes = new WeakMap(), _a = IsDmlEntity;
