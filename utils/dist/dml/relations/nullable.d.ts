 ...
 */
export declare class RelationNullableModifier<T, Relation extends RelationshipType<T>> implements RelationshipType<T | null> {
    #private;
    [IsNullableModifier]: true;
    [IsRelationship]: true;
    static isNullableModifier<T>(modifier: any): modifier is RelationNullableModifier<T, any>;
    type: Relation["type"];
    /**
