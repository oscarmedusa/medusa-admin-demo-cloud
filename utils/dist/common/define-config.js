...
function defineConfig(config = {}) {
     ...
     */
    const modules = {
        [definition_1.Modules.CACHE]: true,
        [definition_1.Modules.EVENT_BUS]: true,
        [definition_1.Modules.WORKFLOW_ENGINE]: true,
        [definition_1.Modules.STOCK_LOCATION]: true,
        [definition_1.Modules.INVENTORY]: true,
        [definition_1.Modules.PRODUCT]: true,
        [definition_1.Modules.PRICING]: true,
        [definition_1.Modules.PROMOTION]: true,
        [definition_1.Modules.CUSTOMER]: true,
        [definition_1.Modules.SALES_CHANNEL]: true,
        [definition_1.Modules.CART]: true,
        [definition_1.Modules.REGION]: true,
        [definition_1.Modules.API_KEY]: true,
        [definition_1.Modules.STORE]: true,
        [definition_1.Modules.TAX]: true,
        [definition_1.Modules.CURRENCY]: true,
        [definition_1.Modules.PAYMENT]: true,
        [definition_1.Modules.ORDER]: true,
        [definition_1.Modules.AUTH]: {
        ...
        [definition_1.Modules.USER]: {
            resolve: "@medusajs/user",
            options: {
                jwt_secret: process.env.JWT_SECRET ?? DEFAULT_SECRET,
            },
        },
        [definition_1.Modules.FILE]: {
        ...
        [definition_1.Modules.FULFILLMENT]: {
        ...
        [definition_1.Modules.NOTIFICATION]: {
