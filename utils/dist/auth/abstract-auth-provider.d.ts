import { AuthenticationInput, AuthenticationResponse, AuthIdentityProviderService, IAuthProvider } from "@medusajs/types";
/**
 * ### constructor
 *
 ...
 * ```
 */
export declare abstract class AbstractAuthModuleProvider implements IAuthProvider {
    /**
     * @ignore
     */
     ...
     * ```
     */
    abstract authenticate(data: AuthenticationInput, authIdentityProviderService: AuthIdentityProviderService): Promise<AuthenticationResponse>;
    /**
