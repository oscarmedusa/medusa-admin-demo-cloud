...
function defineJoinerConfig(serviceName, { alias, schema, models, linkableKeys, primaryKeys, } = {}) {
    ...
    if (!primaryKeys && modelDefinitions.size) {
        ...
        primaryKeys = (0, common_1.deduplicate)(Object.values(linkConfig).flatMap((entityLinkConfig) => {
 ...
 * @param models
 */
function buildLinkConfigFromModelObjects(serviceName, models) {
    const linkConfig = {};
        ...
        for (const [property, value] of Object.entries(schema)) {
            ...
            if (primary_key_1.PrimaryKeyModifier.isPrimaryKeyModifier(value)) {
                ...
                modelLinkConfig[property] = {
                    ...
                    entity: (0, common_1.upperCaseFirst)(model.name),
                };
            }
        }
    }
