import { BaseFilterable, Context, DAL, FilterQuery, FilterQuery as InternalFilterQuery, PerformedActions, RepositoryService, RepositoryTransformOptions, UpsertWithReplaceConfig } from "@medusajs/types";
...
export declare class MikroOrmBaseRepository<T extends object = object> extends MikroOrmBase<T> implements RepositoryService<T> {
    ...
    upsertWithReplace(data: unknown[], config?: UpsertWithReplaceConfig<T>, context?: Context): Promise<{
        entities: T[];
