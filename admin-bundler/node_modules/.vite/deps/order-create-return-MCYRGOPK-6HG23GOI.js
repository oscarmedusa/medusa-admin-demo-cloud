...
// node_modules/@medusajs/dashboard/dist/order-create-return-MCYRGOPK.mjs
      ...
      (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-1 items-center gap-x-3", children: [
        ...
        (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-col", children: [
          (0, import_jsx_runtime3.jsxs)("div", { children: [
            ...
            item.variant.sku && (0, import_jsx_runtime3.jsxs)("span", { children: [
              "(",
              item.variant.sku,
              ")"
            ] })
          ] }),
          (0, import_jsx_runtime3.jsx)(Text, { as: "div", className: "text-ui-fg-subtle txt-small", children: item.variant.product.title })
        ] })
      ] }),
...
var ReturnCreateForm = ({
  ...
  return (0, import_jsx_runtime4.jsx)(
    RouteFocusModal.Form,
    {
      ...
      children: (0, import_jsx_runtime4.jsxs)("form", { onSubmit: handleSubmit, className: "flex h-full flex-col", children: [
...
//# sourceMappingURL=order-create-return-MCYRGOPK-6HG23GOI.js.map
