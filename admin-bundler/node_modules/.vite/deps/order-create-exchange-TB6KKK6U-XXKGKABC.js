import {
  ItemPlaceholder
} from "./chunk-D5OTRLCM.js";
import {
  OutboundShippingPlaceholder,
  ReturnShippingPlaceholder
} from "./chunk-P3AMYKF6.js";
import {
  useReturnReasons
} from "./chunk-7RRPTVDF.js";
import {
  MoneyAmountCell
} from "./chunk-WXCPW5KC.js";
import {
...
// node_modules/@medusajs/dashboard/dist/order-create-exchange-TB6KKK6U.mjs
  ...
  return (0, import_react5.useMemo)(
    () => [
      ...
      columnHelper.display({
        ...
        cell: ({ row }) => (0, import_jsx_runtime.jsx)(ProductCell, { product: row.original.variant.product })
      }),
  ...
  const queriedItems = (0, import_react4.useMemo)(() => {
    ...
    if (q) {
      results = results.filter((i) => {
        var _a;
        return i.variant.product.title.toLowerCase().includes(q.toLowerCase()) || i.variant.title.toLowerCase().includes(q.toLowerCase()) || ((_a = i.variant.sku) == null ? void 0 : _a.toLowerCase().includes(q.toLowerCase()));
      });
    }
    if (order) {
      ...
      (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-1 items-center gap-x-3", children: [
        ...
        (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-col", children: [
          (0, import_jsx_runtime3.jsxs)("div", { children: [
            ...
            ((_a = item.variant) == null ? void 0 : _a.sku) && (0, import_jsx_runtime3.jsxs)("span", { children: [
              "(",
              item.variant.sku,
              ")"
            ] })
          ] }),
          (0, import_jsx_runtime3.jsx)(Text, { as: "div", className: "text-ui-fg-subtle txt-small", children: (_c = (_b = item.variant) == null ? void 0 : _b.product) == null ? void 0 : _c.title })
        ] })
      ] }),
...
var ExchangeInboundSection = ({
  ...
  const showLevelsWarning = (0, import_react3.useMemo)(() => {
    ...
    const allItemsHaveLocation = inboundItems.map((_i) => {
      ...
      return (_a2 = inventoryMap[item.variant_id]) == null ? void 0 : _a2.find(
...
var ExchangeOutboundSection = ({
  ...
  const showLevelsWarning = (0, import_react6.useMemo)(() => {
    ...
    const allItemsHaveLocation = outboundItems.map((i) => {
      ...
      return (_a = inventoryMap[item.variant_id]) == null ? void 0 : _a.find(
        (l) => l.location_id === locationId
      );
    }).every(Boolean);
    return !allItemsHaveLocation;
...
var ExchangeCreateForm = ({
  ...
  return (0, import_jsx_runtime9.jsx)(RouteFocusModal.Form, { form, children: (0, import_jsx_runtime9.jsxs)("form", { onSubmit: handleSubmit, className: "flex h-full flex-col", children: [
...
//# sourceMappingURL=order-create-exchange-TB6KKK6U-XXKGKABC.js.map
