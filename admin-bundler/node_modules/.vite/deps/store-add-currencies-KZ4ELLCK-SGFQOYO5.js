...
// node_modules/@medusajs/dashboard/dist/store-add-currencies-KZ4ELLCK.mjs
...
var AddCurrenciesForm = ({
  ...
  const form = useForm({
    defaultValues: {
      currencies: [],
      pricePreferences: pricePreferences == null ? void 0 : pricePreferences.reduce((acc, curr) => {
        if (curr.value) {
  ...
  return (0, import_jsx_runtime.jsx)(RouteFocusModal.Form, { form, children: (0, import_jsx_runtime.jsxs)(
    "form",
    {
      ...
      children: [
        (0, import_jsx_runtime.jsx)(RouteFocusModal.Header, { children: (0, import_jsx_runtime.jsxs)("div", { className: "flex flex-1 items-center justify-between", children: [
          (0, import_jsx_runtime.jsx)("div", { className: "flex items-center", children: form.formState.errors.currencies && (0, import_jsx_runtime.jsx)(Hint, { variant: "error", children: form.formState.errors.currencies.message }) }),
...
//# sourceMappingURL=store-add-currencies-KZ4ELLCK-SGFQOYO5.js.map
