...
// node_modules/@medusajs/dashboard/dist/chunk-R5UFUQNC.mjs
...
var useDataGridCellHandlers = ({
  ...
  const getWrapperMouseOverHandler = (0, import_react5.useCallback)(
    (coords) => {
      ...
      return (_e) => {
        if ((anchor == null ? void 0 : anchor.col) !== coords.col) {
          return;
        }
        if (isSelecting) {
          setRangeEnd(coords);
    ...
    [anchor == null ? void 0 : anchor.col, isDragging, isSelecting, setDragEnd, setRangeEnd]
  );
...
var DataGridRowErrorIndicator = ({
  ...
  return (0, import_jsx_runtime.jsx)(
    Tooltip,
    {
      content: (0, import_jsx_runtime.jsx)("ul", { className: "flex flex-col gap-y-3", children: rowErrors.map((error, index) => (0, import_jsx_runtime.jsx)(DataGridRowErrorLine, { error }, index)) }),
      delayDuration: 0,
      children: (0, import_jsx_runtime.jsx)(Badge, { color: "red", size: "2xsmall", className: "cursor-default", children: rowErrorCount })
    }
  );
};
var DataGridRowErrorLine = ({
  ...
  return (0, import_jsx_runtime.jsxs)("li", { className: "txt-compact-small flex flex-col items-start", children: [
    error.message,
      ...
      children: [
        (0, import_jsx_runtime2.jsx)(
          s,
          {
            ...
            errors,
            render: ({ message }) => {
              return (0, import_jsx_runtime2.jsx)("div", { className: "flex items-center justify-center", children: (0, import_jsx_runtime2.jsx)(Tooltip, { content: message, delayDuration: 0, children: (0, import_jsx_runtime2.jsx)(ExclamationCircle, { className: "text-ui-tag-red-icon z-[3]" }) }) });
            }
          }
        ),
        (0, import_jsx_runtime2.jsx)("div", { className: "relative z-[1] flex size-full items-center justify-center", children: (0, import_jsx_runtime2.jsx)(RenderChildren, { isAnchor, placeholder, children }) }),
        (0, import_jsx_runtime2.jsx)(DataGridRowErrorIndicator, { rowErrors }),
        showOverlay && (0, import_jsx_runtime2.jsx)(
          "div",
          {
            ...overlayProps,
...
var DataGridBooleanCell = ({
  ...
  return (0, import_jsx_runtime3.jsx)(
    Controller,
    {
      ...
      name: field,
      render: ({ field: field2 }) => {
        return (0, import_jsx_runtime3.jsx)(DataGridCellContainer, { ...container, ...errorProps, children: (0, import_jsx_runtime3.jsx)(Inner, { field: field2, inputProps: input, disabled }) });
      }
    }
  );
};
...
var DataGridCurrencyCell = ({
  ...
  return (0, import_jsx_runtime4.jsx)(
    Controller,
    {
      ...
      name: field,
      render: ({ field: field2 }) => {
        return (0, import_jsx_runtime4.jsx)(DataGridCellContainer, { ...container, ...errorProps, children: (0, import_jsx_runtime4.jsx)(Inner2, { field: field2, inputProps: input, currencyInfo: currency }) });
      }
    }
  );
};
var Inner2 = ({
  ...
  return (0, import_jsx_runtime4.jsxs)("div", { className: "relative flex size-full items-center", children: [
...
var DataGridNumberCell = ({
  ...
  return (0, import_jsx_runtime5.jsx)(
    Controller,
    {
      ...
      name: field,
      render: ({ field: field2 }) => {
        return (0, import_jsx_runtime5.jsx)(DataGridCellContainer, { ...container, ...errorProps, children: (0, import_jsx_runtime5.jsx)(Inner3, { field: field2, inputProps: input, ...rest }) });
      }
    }
  );
};
var Inner3 = ({
  ...
  return (0, import_jsx_runtime5.jsx)("div", { className: "size-full", children: (0, import_jsx_runtime5.jsx)(
    "input",
    {
      ref: combinedRefs,
      value: localValue,
...
var DataGridReadonlyCell = ({
  ...
  return (0, import_jsx_runtime6.jsxs)("div", { className: "bg-ui-bg-subtle txt-compact-small text-ui-fg-subtle flex size-full cursor-not-allowed items-center justify-between overflow-hidden px-4 py-2.5 outline-none", children: [
    (0, import_jsx_runtime6.jsx)("span", { className: "truncate", children }),
    (0, import_jsx_runtime6.jsx)(DataGridRowErrorIndicator, { rowErrors })
  ] });
};
...
var DataGridKeyboardShortcutModal = ({
  ...
  return (0, import_jsx_runtime7.jsxs)(Root, { open, onOpenChange, children: [
    (0, import_jsx_runtime7.jsx)(Trigger, { asChild: true, children: (0, import_jsx_runtime7.jsx)(Button, { size: "small", variant: "secondary", children: t("dataGrid.shortcuts.label") }) }),
    (0, import_jsx_runtime7.jsxs)(Portal2, { children: [
      ...
      (0, import_jsx_runtime7.jsxs)(Content, { className: "bg-ui-bg-subtle shadow-elevation-modal fixed left-[50%] top-[50%] flex h-full max-h-[612px] w-full max-w-[560px] translate-x-[-50%] translate-y-[-50%] flex-col divide-y overflow-hidden rounded-lg outline-none", children: [
        (0, import_jsx_runtime7.jsxs)("div", { className: "flex flex-col gap-y-3 px-6 py-4", children: [
          (0, import_jsx_runtime7.jsxs)("div", { className: "flex items-center justify-between", children: [
            (0, import_jsx_runtime7.jsxs)("div", { children: [
              (0, import_jsx_runtime7.jsx)(Title, { asChild: true, children: (0, import_jsx_runtime7.jsx)(Heading, { children: t("app.menus.user.shortcuts") }) }),
              (0, import_jsx_runtime7.jsx)(Description, { className: "sr-only" })
            ] }),
            (0, import_jsx_runtime7.jsxs)("div", { className: "flex items-center gap-x-2", children: [
              (0, import_jsx_runtime7.jsx)(Kbd, { children: "esc" }),
              (0, import_jsx_runtime7.jsx)(Close, { asChild: true, children: (0, import_jsx_runtime7.jsx)(IconButton, { variant: "transparent", size: "small", children: (0, import_jsx_runtime7.jsx)(XMark, {}) }) })
            ] })
          ] }),
        ...
        (0, import_jsx_runtime7.jsx)("div", { className: "flex flex-col divide-y overflow-y-auto", children: searchResults.map((shortcut, index) => {
          var _a;
          return (0, import_jsx_runtime7.jsxs)(
            "div",
            {
              ...
              children: [
                (0, import_jsx_runtime7.jsx)(Text, { size: "small", children: shortcut.label }),
                (0, import_jsx_runtime7.jsx)("div", { className: "flex items-center gap-x-1", children: (_a = shortcut.keys.Mac) == null ? void 0 : _a.map((key, index2) => {
                  return (0, import_jsx_runtime7.jsx)("div", { className: "flex items-center gap-x-1", children: (0, import_jsx_runtime7.jsx)(Kbd, { children: key }) }, index2);
                }) })
              ]
            },
            index
...
var DataGridRoot = ({
  ...
  const [trapActive, setTrapActive] = (0, import_react18.useState)(true);
  ...
  return (0, import_jsx_runtime8.jsx)(DataGridContext.Provider, { value: values, children: (0, import_jsx_runtime8.jsxs)("div", { className: "bg-ui-bg-subtle flex size-full flex-col", children: [
    ...
    (0, import_jsx_runtime8.jsx)("div", { className: "size-full overflow-hidden", children: (0, import_jsx_runtime8.jsx)(
      "div",
      {
        ref: containerRef,
        autoFocus: true,
        ...
        "data-container": true,
        role: "application",
        children: (0, import_jsx_runtime8.jsxs)("div", { role: "grid", className: "text-ui-fg-subtle grid", children: [
          (0, import_jsx_runtime8.jsx)(
            "div",
            {
              role: "rowgroup",
              className: "txt-compact-small-plus bg-ui-bg-subtle sticky top-0 z-[1] grid",
              children: grid.getHeaderGroups().map((headerGroup) => (0, import_jsx_runtime8.jsxs)(
                "div",
                {
                  role: "row",
                  className: "flex h-10 w-full",
                  children: [
                    virtualPaddingLeft ? (0, import_jsx_runtime8.jsx)(
                      "div",
                      {
                        role: "presentation",
                    ...
                    virtualPaddingRight ? (0, import_jsx_runtime8.jsx)(
                      "div",
                      {
                        role: "presentation",
                        style: {
...
var DataGridHeader = ({
  ...
  return (0, import_jsx_runtime8.jsxs)("div", { className: "bg-ui-bg-base flex items-center justify-between border-b p-4", children: [
    (0, import_jsx_runtime8.jsxs)("div", { className: "flex items-center gap-x-2", children: [
      (0, import_jsx_runtime8.jsxs)(DropdownMenu, { open: columnsOpen, onOpenChange: handleColumnsOpenChange, children: [
        (0, import_jsx_runtime8.jsx)(
          ConditionalTooltip,
          {
            showTooltip: isDisabled,
            content: t("dataGrid.columns.disabled"),
            children: (0, import_jsx_runtime8.jsx)(DropdownMenu.Trigger, { asChild: true, disabled: isDisabled, children: (0, import_jsx_runtime8.jsxs)(Button, { size: "small", variant: "secondary", children: [
              hasChanged ? (0, import_jsx_runtime8.jsx)(AdjustmentsDone, {}) : (0, import_jsx_runtime8.jsx)(Adjustments, {}),
              t("dataGrid.columns.view")
            ] }) })
          }
        ),
        (0, import_jsx_runtime8.jsx)(DropdownMenu.Content, { children: columnOptions.map((column, index) => {
      ...
      hasChanged && (0, import_jsx_runtime8.jsx)(
        Button,
        {
          size: "small",
          variant: "transparent",
    ...
    (0, import_jsx_runtime8.jsxs)("div", { className: "flex items-center gap-x-2", children: [
      errorCount > 0 && (0, import_jsx_runtime8.jsxs)(
        Button,
        {
          size: "small",
          variant: "secondary",
          ...
          children: [
            (0, import_jsx_runtime8.jsx)(ExclamationCircle, { className: "text-ui-fg-subtle" }),
            (0, import_jsx_runtime8.jsx)("span", { children: t("dataGrid.errors.count", {
              count: errorCount
            }) })
          ]
        }
...
var DataGridCell = ({
  ...
  return (0, import_jsx_runtime8.jsx)(
    "div",
    {
      ...
      tabIndex: -1,
      children: (0, import_jsx_runtime8.jsxs)("div", { className: "relative h-full w-full", children: [
        flexRender(cell.column.columnDef.cell, {
          ...cell.getContext(),
          columnIndex,
          rowIndex
        }),
        isAnchor && (0, import_jsx_runtime8.jsx)(
          "div",
          {
...
var DataGridSkeleton = ({
  ...
  return (0, import_jsx_runtime9.jsxs)("div", { className: "bg-ui-bg-subtle size-full", children: [
    (0, import_jsx_runtime9.jsx)("div", { className: "bg-ui-bg-base border-b p-4", children: (0, import_jsx_runtime9.jsx)("div", { className: "bg-ui-button-neutral h-7 w-[116px] animate-pulse rounded-md" }) }),
    (0, import_jsx_runtime9.jsxs)("div", { className: "bg-ui-bg-subtle size-full overflow-auto", children: [
          ...
          children: columns.map((_col, i) => {
            return (0, import_jsx_runtime9.jsx)(
              "div",
              {
                ...
                children: (0, import_jsx_runtime9.jsx)(Skeleton, { className: "h-[14px] w-[164px]" })
              },
              i
            );
          })
      ...
      (0, import_jsx_runtime9.jsx)("div", { children: rows.map((_, j) => (0, import_jsx_runtime9.jsx)(
        "div",
        {
          className: "grid",
...
var IncludesTaxTooltip = ({
  ...
  return (0, import_jsx_runtime12.jsx)(
    Tooltip,
    {
      ...
      children: (0, import_jsx_runtime12.jsx)(BuildingTax, { className: clx({ "text-ui-fg-muted": !includesTax }) })
    }
  );
};
...
//# sourceMappingURL=chunk-IW7WG74X.js.map
