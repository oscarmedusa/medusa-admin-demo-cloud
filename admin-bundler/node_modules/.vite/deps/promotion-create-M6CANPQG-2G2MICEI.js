...
} from "./chunk-PUDYRP7L.js";
import {
  AddCampaignPromotionFields
} from "./chunk-QTJNWDMV.js";
import {
  RulesFormField
} from "./chunk-CGTNABQ2.js";
import {
  CreateCampaignSchema,
  defaultCampaignValues
} from "./chunk-JI4IJ2FW.js";
import "./chunk-7KVXQLHY.js";
import "./chunk-EWBNMDEK.js";
import {
  getCurrencySymbol
...
// node_modules/@medusajs/dashboard/dist/promotion-create-M6CANPQG.mjs
...
var CreatePromotionForm = () => {
  ...
  const [detailsValidated, setDetailsValidated] = (0, import_react.useState)(false);
  ...
  const detailsProgress = (0, import_react.useMemo)(() => {
    if (detailsValidated) {
      return "completed";
    }
    return "not-started";
  ...
  return (0, import_jsx_runtime.jsx)(RouteFocusModal.Form, { form, children: (0, import_jsx_runtime.jsxs)("form", { className: "flex h-full flex-col", onSubmit: handleSubmit, children: [
      ...
      ProgressTabs,
      {
        ...
        children: [
          (0, import_jsx_runtime.jsx)(RouteFocusModal.Header, { children: (0, import_jsx_runtime.jsx)("div", { className: "flex w-full items-center justify-between gap-x-4", children: (0, import_jsx_runtime.jsx)("div", { className: "-my-2 w-full max-w-[600px] border-l", children: (0, import_jsx_runtime.jsxs)(ProgressTabs.List, { className: "grid w-full grid-cols-3", children: [
            ...
            (0, import_jsx_runtime.jsx)(ProgressTabs.Trigger, { className: "w-full", value: "campaign", children: t2("promotions.tabs.campaign") })
          ] }) }) }) }),
                ...
                children: (0, import_jsx_runtime.jsx)("div", { className: "flex size-full flex-col items-center", children: (0, import_jsx_runtime.jsxs)("div", { className: "flex w-full max-w-[720px] flex-col gap-y-8 py-16", children: [
                  ...
                  (0, import_jsx_runtime.jsx)(
                    Form.Field,
                    {
                      ...
                      render: ({ field }) => {
                        return (0, import_jsx_runtime.jsxs)(Form.Item, { children: [
                          (0, import_jsx_runtime.jsx)(Form.Label, { children: "Method" }),
...
//# sourceMappingURL=promotion-create-M6CANPQG-2G2MICEI.js.map
