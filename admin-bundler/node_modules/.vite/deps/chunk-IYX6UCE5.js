...
} from "./chunk-HEJ3XJWY.js";
import {
  TaxRateRuleReferenceType
} from "./chunk-BMU5D5R7.js";
import {
  formatPercentage
} from "./chunk-JS2IEJXU.js";
import {
  DataTableSearch
} from "./chunk-EIGZCZHJ.js";
import {
  DataTableOrderBy
} from "./chunk-CEIAMOT7.js";
import {
  NoRecords,
  NoResults
...
// node_modules/@medusajs/dashboard/dist/chunk-TN3G3QJM.mjs
...
var TaxOverrideCard = ({ taxRate }) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(Root, { children: [
    (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center justify-between px-6 py-3", children: [
      (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center gap-x-2", children: [
        (0, import_jsx_runtime2.jsx)(Trigger, { asChild: true, children: (0, import_jsx_runtime2.jsx)(IconButton, { size: "2xsmall", variant: "transparent", className: "group", children: (0, import_jsx_runtime2.jsx)(TriangleRightMini, { className: "text-ui-fg-muted transition-transform group-data-[state='open']:rotate-90" }) }) }),
    ...
    (0, import_jsx_runtime2.jsx)(Content, { children: (0, import_jsx_runtime2.jsxs)("div", { className: "bg-ui-bg-subtle", children: [
...
var useReferenceValues = (type, ids) => {
  ...
  const products = useProducts(
    ...
    {
      enabled: !!ids.length && type === "products"
      /* PRODUCT */
    }
  );
  const tags = useProductTags(
    ...
    {
      enabled: !!ids.length && type === "product_tags"
      /* PRODUCT_TAG */
    }
  );
  const productTypes = useProductTypes(
    ...
    {
      enabled: !!ids.length && type === "product_types"
      /* PRODUCT_TYPE */
    }
  );
  const collections = useCollections(
    ...
    {
      enabled: !!ids.length && type === "product_collections"
      /* PRODUCT_COLLECTION */
    }
  );
  const customerGroups = useCustomerGroups(
    ...
    {
      enabled: !!ids.length && type === "customer_groups"
      /* CUSTOMER_GROUP */
    }
  );
  switch (type) {
    ...
    case "product_tags":
      return {
        labels: (_b = tags.product_tags) == null ? void 0 : _b.map((tag) => tag.value),
    ...
    case "product_types":
      return {
        labels: (_c = productTypes.product_types) == null ? void 0 : _c.map((type2) => type2.value),
    ...
    case "product_collections":
      return {
        labels: (_d = collections.collections) == null ? void 0 : _d.map((collection) => collection.title),
    ...
    case "customer_groups":
      return {
        labels: (_e = customerGroups.customer_groups) == null ? void 0 : _e.map((group) => group.name),
...
//# sourceMappingURL=chunk-IYX6UCE5.js.map
