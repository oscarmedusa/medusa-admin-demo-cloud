...
// node_modules/@medusajs/dashboard/dist/chunk-RLLZZQKN.mjs
...
var RouteModalProviderContext = (0, import_react3.createContext)(null);
var RouteModalProvider = ({
  prev,
  children
}) => {
  const navigate = useNavigate();
  const [closeOnEscape, setCloseOnEscape] = (0, import_react2.useState)(true);
...
var StackedModalContext = (0, import_react5.createContext)(null);
...
var useStackedModal = () => {
  const context = (0, import_react6.useContext)(StackedModalContext);
  if (!context) {
    throw new Error(
...
var Root = ({ prev = "..", children }) => {
  ...
  return (0, import_jsx_runtime4.jsx)(Drawer, { open, onOpenChange: handleOpenChange, children: (0, import_jsx_runtime4.jsx)(RouteModalProvider, { prev, children: (0, import_jsx_runtime4.jsx)(StackedModalProvider, { onOpenChange: onStackedModalOpen, children: (0, import_jsx_runtime4.jsx)(
    Drawer.Content,
    {
      className: clx({
...
var useRouteModal = () => {
  const context = (0, import_react7.useContext)(RouteModalProviderContext);
  if (!context) {
...
var Root2 = ({ prev = "..", children }) => {
  ...
  const [stackedModalOpen, onStackedModalOpen] = (0, import_react8.useState)(false);
  ...
  return (0, import_jsx_runtime5.jsx)(FocusModal, { open, onOpenChange: handleOpenChange, children: (0, import_jsx_runtime5.jsx)(RouteModalProvider, { prev, children: (0, import_jsx_runtime5.jsx)(StackedModalProvider, { onOpenChange: onStackedModalOpen, children: (0, import_jsx_runtime5.jsx)(Content, { stackedModalOpen, children }) }) }) });
};
...
var Content2 = (0, import_react9.forwardRef)(({ className, ...props }, ref) => {
...
var Content3 = (0, import_react10.forwardRef)(({ className, ...props }, ref) => {
  return (0, import_jsx_runtime7.jsx)(
    FocusModal.Content,
    {
      ref,
...
//# sourceMappingURL=chunk-3P6F4Q7W.js.map
