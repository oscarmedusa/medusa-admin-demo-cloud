      ...
      /* @__PURE__ */ jsx("div", { className: "flex flex-1 items-center", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-x-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-row", children: [
            /* @__PURE__ */ jsx(Text, { className: "txt-small flex", as: "span", weight: "plus", children: item.variant.product.title }),
            item.variant.sku && /* @__PURE__ */ jsxs("span", { className: "text-ui-fg-subtle", children: [
              " ",
              "(",
              item.variant.sku,
              ")"
