...
var Icon = ({ childrenCount, collapsed, clone }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex size-7 items-center justify-center", children: isBranch ? isOpen ? /* @__PURE__ */ jsx(FolderOpenIllustration, {}) : /* @__PURE__ */ jsx(FolderIllustration, {}) : /* @__PURE__ */ jsx(Swatch, { className: "text-ui-fg-muted" }) });
};
