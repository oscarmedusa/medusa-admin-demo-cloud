    ...
    return [
      columnHelper.column({
        ...
        cell: (context) => {
          ...
          return /* @__PURE__ */ jsx2(DataGrid.ReadonlyCell, { context, children: /* @__PURE__ */ jsx2("div", { className: "flex h-full w-full items-center gap-x-2 overflow-hidden", children: /* @__PURE__ */ jsx2("span", { className: "truncate", children: entity.title }) }) });
        },
        disableHiding: true
      }),
      ...createDataGridPriceColumns({
...
function InventoryKitTab({ form }) {
  ...
  return /* @__PURE__ */ jsx3("div", { className: "flex flex-col items-center p-16", children: /* @__PURE__ */ jsx3("div", { className: "flex w-full max-w-[720px] flex-col gap-y-8", children: /* @__PURE__ */ jsxs2("div", { id: "organize", className: "flex flex-col gap-y-8", children: [
    /* @__PURE__ */ jsx3(Heading2, { children: t("products.create.inventory.heading") }),
    /* @__PURE__ */ jsxs2("div", { className: "grid gap-y-4", children: [
      /* @__PURE__ */ jsxs2("div", { className: "flex items-start justify-between gap-x-4", children: [
        /* @__PURE__ */ jsxs2("div", { className: "flex flex-col", children: [
          /* @__PURE__ */ jsx3(Form.Label, { children: form.getValues("title") }),
          /* @__PURE__ */ jsx3(Form.Hint, { children: t("products.create.inventory.label") })
        ] }),
        /* @__PURE__ */ jsx3(
          Button,
          {
        ...
        "li",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs2("div", { className: "grid grid-cols-[min-content,1fr] items-center gap-1.5", children: [
              /* @__PURE__ */ jsx3("div", { className: "flex items-center px-2 py-1.5", children: /* @__PURE__ */ jsx3(
                Label,
                {
                  size: "xsmall",
                  weight: "plus",
