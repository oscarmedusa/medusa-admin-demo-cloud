...
var useReferenceValues = (type, ids) => {
  const products = useProducts(
    ...
    {
      enabled: !!ids.length && type === "products" /* PRODUCT */
    }
  );
  const tags = useProductTags(
    ...
    {
      enabled: !!ids.length && type === "product_tags" /* PRODUCT_TAG */
    }
  );
  const productTypes = useProductTypes(
    ...
    {
      enabled: !!ids.length && type === "product_types" /* PRODUCT_TYPE */
    }
  );
  const collections = useCollections(
    ...
    {
      enabled: !!ids.length && type === "product_collections" /* PRODUCT_COLLECTION */
    }
  );
  const customerGroups = useCustomerGroups(
    ...
    {
      enabled: !!ids.length && type === "customer_groups" /* CUSTOMER_GROUP */
    }
  );
  switch (type) {
    case "products" /* PRODUCT */:
