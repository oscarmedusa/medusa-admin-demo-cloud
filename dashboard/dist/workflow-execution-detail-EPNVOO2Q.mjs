  ...
  return /* @__PURE__ */ jsxs(Container, { className: "divide-y p-0", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-6 py-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-x-0.5", children: [
        /* @__PURE__ */ jsx(Heading, { children: cleanId }),
        /* @__PURE__ */ jsx(Copy, { content: cleanId, className: "text-ui-fg-muted" })
      ] }),
      /* @__PURE__ */ jsx(StatusBadge, { color: stateColor, children: translatedState })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "text-ui-fg-subtle grid grid-cols-2 px-6 py-4", children: [
      /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", weight: "plus", children: t("workflowExecutions.workflowIdLabel") }),
      /* @__PURE__ */ jsx(Badge, { size: "2xsmall", className: "w-fit", children: execution.workflow_id })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "text-ui-fg-subtle grid grid-cols-2 px-6 py-4", children: [
      /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", weight: "plus", children: t("workflowExecutions.transactionIdLabel") }),
      /* @__PURE__ */ jsx(Badge, { size: "2xsmall", className: "w-fit", children: execution.transaction_id })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "text-ui-fg-subtle grid grid-cols-2 px-6 py-4", children: [
      /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", weight: "plus", children: t("workflowExecutions.progressLabel") }),
      /* @__PURE__ */ jsx(Progress, { steps: execution.execution?.steps })
    ] })
  ] });
};
...
var Progress = ({
  ...
  const { t } = useTranslation();
  if (!steps) {
    return /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", className: "text-ui-fg-subtle", children: t("workflowExecutions.stepsCompletedLabel", {
      completed: 0,
      total: 0
    }) });
  }
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex w-fit items-center gap-x-2", children: [
    /* @__PURE__ */ jsx("div", { className: "flex items-center gap-x-[3px]", children: actionableSteps.map((step) => /* @__PURE__ */ jsx(
      "div",
      {
        className: clx(
    ...
    /* @__PURE__ */ jsx(Text, { size: "small", leading: "compact", className: "text-ui-fg-subtle", children: t("workflowExecutions.stepsCompletedLabel", {
...
var WorkflowExecutionHistorySection = ({
  ...
  return /* @__PURE__ */ jsxs2(Container2, { className: "divide-y p-0", children: [
    /* @__PURE__ */ jsx2("div", { className: "flex items-center justify-between px-6 py-4", children: /* @__PURE__ */ jsx2(Heading2, { level: "h2", children: t("workflowExecutions.history.sectionTitle") }) }),
    /* @__PURE__ */ jsx2("div", { className: "flex flex-col gap-y-0.5 px-6 py-4", children: steps.map((step, index) => {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs2("div", { className: "grid h-full grid-rows-[20px_1fr] items-center justify-center gap-y-0.5", children: [
          /* @__PURE__ */ jsx2("div", { className: "flex size-5 items-center justify-center", children: /* @__PURE__ */ jsx2("div", { className: "bg-ui-bg-base shadow-borders-base flex size-2.5 items-center justify-center rounded-full", children: /* @__PURE__ */ jsx2(
            "div",
            {
          ...
          /* @__PURE__ */ jsx2("div", { className: "flex h-full flex-col items-center", children: /* @__PURE__ */ jsx2(
            "div",
            {
              "aria-hidden": true,
              role: "presentation",
        ...
        /* @__PURE__ */ jsxs2(Collapsible.Root, { open, onOpenChange: setOpen, children: [
          /* @__PURE__ */ jsx2(Collapsible.Trigger, { asChild: true, children: /* @__PURE__ */ jsxs2("div", { className: "group flex cursor-pointer items-start justify-between outline-none", children: [
            /* @__PURE__ */ jsx2(Text2, { size: "small", leading: "compact", weight: "plus", children: identifier }),
            /* @__PURE__ */ jsxs2("div", { className: "flex items-center gap-x-2", children: [
              ...
              /* @__PURE__ */ jsx2(IconButton, { size: "2xsmall", variant: "transparent", children: /* @__PURE__ */ jsx2(TriangleDownMini, { className: "text-ui-fg-muted transition-transform group-data-[state=open]:rotate-180" }) })
            ] })
          ] }) }),
          /* @__PURE__ */ jsx2(Collapsible.Content, { ref, children: /* @__PURE__ */ jsxs2("div", { className: "flex flex-col gap-y-2 pb-4 pt-2", children: [
            /* @__PURE__ */ jsxs2("div", { className: "text-ui-fg-subtle flex flex-col gap-y-2", children: [
              /* @__PURE__ */ jsx2(Text2, { size: "small", leading: "compact", children: t("workflowExecutions.history.definitionLabel") }),
              /* @__PURE__ */ jsx2(
                CodeBlock,
                {
                  snippets: [
                  ...
                  children: /* @__PURE__ */ jsx2(CodeBlock.Body, {})
                }
              )
            ] }),
            stepInvokeContext && /* @__PURE__ */ jsxs2("div", { className: "text-ui-fg-subtle flex flex-col gap-y-2", children: [
              /* @__PURE__ */ jsx2(Text2, { size: "small", leading: "compact", children: t("workflowExecutions.history.outputLabel") }),
              /* @__PURE__ */ jsx2(
                CodeBlock,
                {
                  snippets: [
            ...
            !!stepInvokeContext?.output.compensateInput && step.compensate.state === "reverted" /* REVERTED */ && /* @__PURE__ */ jsxs2("div", { className: "text-ui-fg-subtle flex flex-col gap-y-2", children: [
              /* @__PURE__ */ jsx2(Text2, { size: "small", leading: "compact", children: t("workflowExecutions.history.compensateInputLabel") }),
              /* @__PURE__ */ jsx2(
                CodeBlock,
                {
                  snippets: [
            ...
            stepError && /* @__PURE__ */ jsxs2("div", { className: "text-ui-fg-subtle flex flex-col gap-y-2", children: [
              /* @__PURE__ */ jsx2(Text2, { size: "small", leading: "compact", children: t("workflowExecutions.history.errorLabel") }),
              /* @__PURE__ */ jsx2(
                CodeBlock,
                {
                  snippets: [
...
var StepState = ({
  ...
  if (isRunning) {
    return /* @__PURE__ */ jsxs2("div", { className: "flex items-center gap-x-1", children: [
      /* @__PURE__ */ jsx2(Text2, { size: "small", leading: "compact", className: "text-ui-fg-subtle", children: t("workflowExecutions.history.runningState") }),
      /* @__PURE__ */ jsx2(Spinner, { className: "text-ui-fg-interactive animate-spin" })
    ] });
  }
  let stateText;
  if (isSkipped) {
  ...
  if (stateText !== null) {
    return /* @__PURE__ */ jsx2(Text2, { size: "small", leading: "compact", className: "text-ui-fg-subtle", children: stateText });
  }
  if (startedAt) {
    return /* @__PURE__ */ jsx2(Text2, { size: "small", leading: "compact", className: "text-ui-fg-muted", children: format(startedAt, "dd MMM yyyy HH:mm:ss") });
  }
};
...
var WorkflowExecutionPayloadSection = ({
  ...
  return /* @__PURE__ */ jsx3(JsonViewSection, { data: payload });
};
...
var WorkflowExecutionTimelineSection = ({
  ...
  return /* @__PURE__ */ jsxs3(Container3, { className: "overflow-hidden px-0 pb-8 pt-0", children: [
    /* @__PURE__ */ jsx4("div", { className: "flex items-center justify-between px-6 py-4", children: /* @__PURE__ */ jsx4(Heading3, { level: "h2", children: t("general.timeline") }) }),
    /* @__PURE__ */ jsx4("div", { className: "w-full overflow-hidden border-y", children: /* @__PURE__ */ jsx4(Canvas, { execution }) })
  ] });
};
...
var Canvas = ({
  ...
  return /* @__PURE__ */ jsx4("div", { className: "h-[400px] w-full", children: /* @__PURE__ */ jsxs3("div", { ref: dragConstraints, className: "relative size-full", children: [
    /* @__PURE__ */ jsx4("div", { className: "relative size-full overflow-hidden object-contain", children: /* @__PURE__ */ jsx4("div", { children: /* @__PURE__ */ jsx4(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsx4("main", { className: "size-full", children: /* @__PURE__ */ jsx4("div", { className: "absolute left-[1100px] top-[1100px] flex select-none items-start", children: Object.entries(clusters).map(([depth, cluster]) => {
          const next = getNextCluster(clusters, Number(depth));
          return /* @__PURE__ */ jsxs3("div", { className: "flex items-start", children: [
            /* @__PURE__ */ jsx4("div", { className: "flex flex-col justify-center gap-y-2", children: cluster.map((step) => /* @__PURE__ */ jsx4(Node, { step }, step.id)) }),
            /* @__PURE__ */ jsx4(Line, { next })
          ] }, depth);
        }) }) })
      }
    ) }) }),
      ...
      /* @__PURE__ */ jsxs3("div", { className: "flex items-center", children: [
        /* @__PURE__ */ jsx4(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsx4(PlusMini, {})
          }
        ),
        /* @__PURE__ */ jsx4("div", { children: /* @__PURE__ */ jsxs3(DropdownMenu, { children: [
          /* @__PURE__ */ jsx4(DropdownMenu.Trigger, { className: "disabled:text-ui-fg-disabled transition-fg hover:bg-ui-bg-base-hover active:bg-ui-bg-base-pressed focus-visible:bg-ui-bg-base-pressed flex w-[50px] items-center justify-center border-r p-1 outline-none", children: /* @__PURE__ */ jsxs3(
            Text3,
            {
              as: "span",
              size: "xsmall",
          ...
          /* @__PURE__ */ jsx4(DropdownMenu.Content, { children: [50, 75, 100, 125, 150].map((value) => /* @__PURE__ */ jsxs3(
            DropdownMenu.Item,
            {
        ...
        /* @__PURE__ */ jsx4(
          "button",
          {
            ...
            "aria-label": "Zoom out",
            className: "disabled:text-ui-fg-disabled transition-fg hover:bg-ui-bg-base-hover active:bg-ui-bg-base-pressed focus-visible:bg-ui-bg-base-pressed border-r p-1 outline-none",
            children: /* @__PURE__ */ jsx4(MinusMini, {})
          }
        )
      ] }),
      /* @__PURE__ */ jsx4(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsx4(ArrowPathMini, {})
        }
      )
    ] })
  ] }) });
...
var Arrow = ({ depth }) => {
  if (depth === 1) {
    return /* @__PURE__ */ jsx4(HorizontalArrow, {});
  }
  if (depth === 2) {
    return /* @__PURE__ */ jsxs3("div", { className: "flex flex-col items-end", children: [
      /* @__PURE__ */ jsx4(HorizontalArrow, {}),
      /* @__PURE__ */ jsx4(EndArrow, {})
    ] });
  }
  const inbetween = Array.from({ length: depth - 2 }).map((_, index) => /* @__PURE__ */ jsx4(MiddleArrow, {}, index));
  return /* @__PURE__ */ jsxs3("div", { className: "flex flex-col items-end", children: [
    /* @__PURE__ */ jsx4(HorizontalArrow, {}),
    inbetween,
    /* @__PURE__ */ jsx4(EndArrow, {})
...
var Line = ({ next }) => {
  ...
  return /* @__PURE__ */ jsx4("div", { className: "-ml-[5px] -mr-[7px] w-[60px] pr-[7px]", children: /* @__PURE__ */ jsxs3("div", { className: "flex min-h-[24px] w-full items-start", children: [
    /* @__PURE__ */ jsx4("div", { className: "flex h-6 w-2.5 items-center justify-center", children: /* @__PURE__ */ jsx4("div", { className: "bg-ui-button-neutral shadow-borders-base size-2.5 shrink-0 rounded-full" }) }),
    /* @__PURE__ */ jsx4("div", { className: "pt-1.5", children: /* @__PURE__ */ jsx4(Arrow, { depth: next.length }) })
  ] }) });
};
var Node = ({ step }) => {
  if (step.id === "_root") {
    ...
    Link,
    {
      ...
      children: /* @__PURE__ */ jsxs3(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx4("div", { className: "flex size-5 items-center justify-center", children: /* @__PURE__ */ jsx4(
              "div",
              {
                className: clx3(
...
var ExecutionDetail = () => {
  ...
  return /* @__PURE__ */ jsxs4("div", { className: "flex flex-col gap-y-2", children: [
    before.widgets.map((w, i) => {
      return /* @__PURE__ */ jsx5("div", { children: /* @__PURE__ */ jsx5(w.Component, { execution: workflow_execution }) }, i);
    }),
    /* @__PURE__ */ jsx5(WorkflowExecutionGeneralSection, { execution: workflow_execution }),
    /* @__PURE__ */ jsx5(WorkflowExecutionTimelineSection, { execution: workflow_execution }),
    /* @__PURE__ */ jsx5(WorkflowExecutionPayloadSection, { execution: workflow_execution }),
    /* @__PURE__ */ jsx5(WorkflowExecutionHistorySection, { execution: workflow_execution }),
    after.widgets.map((w, i) => {
      return /* @__PURE__ */ jsx5("div", { children: /* @__PURE__ */ jsx5(w.Component, { execution: workflow_execution }) }, i);
    }),
    /* @__PURE__ */ jsx5(JsonViewSection, { data: workflow_execution })
  ] });
};
export {
