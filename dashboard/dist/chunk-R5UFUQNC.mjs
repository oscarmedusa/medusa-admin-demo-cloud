      ...
      children: [
        /* @__PURE__ */ jsx2(
          ErrorMessage,
          {
            ...
            errors,
            render: ({ message }) => {
              return /* @__PURE__ */ jsx2("div", { className: "flex items-center justify-center", children: /* @__PURE__ */ jsx2(Tooltip2, { content: message, delayDuration: 0, children: /* @__PURE__ */ jsx2(ExclamationCircle, { className: "text-ui-tag-red-icon z-[3]" }) }) });
            }
          }
        ),
        /* @__PURE__ */ jsx2("div", { className: "relative z-[1] flex size-full items-center justify-center", children: /* @__PURE__ */ jsx2(RenderChildren, { isAnchor, placeholder, children }) }),
        /* @__PURE__ */ jsx2(DataGridRowErrorIndicator, { rowErrors }),
...
var DataGridBooleanCell = ({
  ...
  return /* @__PURE__ */ jsx3(
    Controller,
    {
      ...
      name: field,
      render: ({ field: field2 }) => {
        return /* @__PURE__ */ jsx3(DataGridCellContainer, { ...container, ...errorProps, children: /* @__PURE__ */ jsx3(Inner, { field: field2, inputProps: input, disabled }) });
      }
    }
  );
};
...
var DataGridCurrencyCell = ({
  ...
  return /* @__PURE__ */ jsx4(
    Controller2,
    {
      ...
      name: field,
      render: ({ field: field2 }) => {
        return /* @__PURE__ */ jsx4(DataGridCellContainer, { ...container, ...errorProps, children: /* @__PURE__ */ jsx4(Inner2, { field: field2, inputProps: input, currencyInfo: currency }) });
      }
    }
  );
};
var Inner2 = ({
  ...
  return /* @__PURE__ */ jsxs3("div", { className: "relative flex size-full items-center", children: [
    /* @__PURE__ */ jsx4(
      "span",
      {
...
var DataGridNumberCell = ({
  ...
  return /* @__PURE__ */ jsx5(
    Controller3,
    {
      ...
      name: field,
      render: ({ field: field2 }) => {
        return /* @__PURE__ */ jsx5(DataGridCellContainer, { ...container, ...errorProps, children: /* @__PURE__ */ jsx5(Inner3, { field: field2, inputProps: input, ...rest }) });
      }
    }
  );
};
var Inner3 = ({
  ...
  return /* @__PURE__ */ jsx5("div", { className: "size-full", children: /* @__PURE__ */ jsx5(
    "input",
    {
      ref: combinedRefs,
      value: localValue,
...
var DataGridReadonlyCell = ({
  ...
  return /* @__PURE__ */ jsxs4("div", { className: "bg-ui-bg-subtle txt-compact-small text-ui-fg-subtle flex size-full cursor-not-allowed items-center justify-between overflow-hidden px-4 py-2.5 outline-none", children: [
    /* @__PURE__ */ jsx6("span", { className: "truncate", children }),
    /* @__PURE__ */ jsx6(DataGridRowErrorIndicator, { rowErrors })
  ] });
};
...
import { Button as Button2, DropdownMenu, clx as clx4 } from "@medusajs/ui";
import {
  flexRender,
  getCoreRowModel,
  useReactTable
...
var DataGridKeyboardShortcutModal = ({
  ...
  return /* @__PURE__ */ jsxs5(Root, { open, onOpenChange, children: [
    /* @__PURE__ */ jsx7(Trigger, { asChild: true, children: /* @__PURE__ */ jsx7(Button, { size: "small", variant: "secondary", children: t("dataGrid.shortcuts.label") }) }),
    /* @__PURE__ */ jsxs5(Portal, { children: [
      /* @__PURE__ */ jsx7(
        Overlay,
        {
          className: clx3(
      ...
      /* @__PURE__ */ jsxs5(Content, { className: "bg-ui-bg-subtle shadow-elevation-modal fixed left-[50%] top-[50%] flex h-full max-h-[612px] w-full max-w-[560px] translate-x-[-50%] translate-y-[-50%] flex-col divide-y overflow-hidden rounded-lg outline-none", children: [
        /* @__PURE__ */ jsxs5("div", { className: "flex flex-col gap-y-3 px-6 py-4", children: [
          /* @__PURE__ */ jsxs5("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxs5("div", { children: [
              /* @__PURE__ */ jsx7(Title, { asChild: true, children: /* @__PURE__ */ jsx7(Heading, { children: t("app.menus.user.shortcuts") }) }),
              /* @__PURE__ */ jsx7(Description, { className: "sr-only" })
            ] }),
            /* @__PURE__ */ jsxs5("div", { className: "flex items-center gap-x-2", children: [
              /* @__PURE__ */ jsx7(Kbd, { children: "esc" }),
              /* @__PURE__ */ jsx7(Close, { asChild: true, children: /* @__PURE__ */ jsx7(IconButton, { variant: "transparent", size: "small", children: /* @__PURE__ */ jsx7(XMark, {}) }) })
            ] })
          ] }),
        ...
        /* @__PURE__ */ jsx7("div", { className: "flex flex-col divide-y overflow-y-auto", children: searchResults.map((shortcut, index) => {
          return /* @__PURE__ */ jsxs5(
            "div",
            {
              className: "text-ui-fg-subtle flex items-center justify-between px-6 py-3",
              children: [
                /* @__PURE__ */ jsx7(Text, { size: "small", children: shortcut.label }),
                /* @__PURE__ */ jsx7("div", { className: "flex items-center gap-x-1", children: shortcut.keys.Mac?.map((key, index2) => {
                  return /* @__PURE__ */ jsx7("div", { className: "flex items-center gap-x-1", children: /* @__PURE__ */ jsx7(Kbd, { children: key }) }, index2);
                }) })
              ]
            },
            index
...
var DataGridRoot = ({
  ...
  const [trapActive, setTrapActive] = useState8(true);
  ...
  return /* @__PURE__ */ jsx8(DataGridContext.Provider, { value: values, children: /* @__PURE__ */ jsxs6("div", { className: "bg-ui-bg-subtle flex size-full flex-col", children: [
    /* @__PURE__ */ jsx8(
      DataGridHeader,
      {
        columnOptions,
    ...
    /* @__PURE__ */ jsx8("div", { className: "size-full overflow-hidden", children: /* @__PURE__ */ jsx8(
      "div",
      {
        ref: containerRef,
        autoFocus: true,
        ...
        "data-container": true,
        role: "application",
        children: /* @__PURE__ */ jsxs6("div", { role: "grid", className: "text-ui-fg-subtle grid", children: [
          /* @__PURE__ */ jsx8(
            "div",
            {
              role: "rowgroup",
              className: "txt-compact-small-plus bg-ui-bg-subtle sticky top-0 z-[1] grid",
              children: grid.getHeaderGroups().map((headerGroup) => /* @__PURE__ */ jsxs6(
                "div",
                {
                  role: "row",
                  className: "flex h-10 w-full",
                  children: [
                    virtualPaddingLeft ? /* @__PURE__ */ jsx8(
                      "div",
                      {
                        role: "presentation",
                    ...
                    virtualPaddingRight ? /* @__PURE__ */ jsx8(
                      "div",
                      {
                        role: "presentation",
                        style: {
...
var DataGridHeader = ({
  ...
  return /* @__PURE__ */ jsxs6("div", { className: "bg-ui-bg-base flex items-center justify-between border-b p-4", children: [
    /* @__PURE__ */ jsxs6("div", { className: "flex items-center gap-x-2", children: [
      /* @__PURE__ */ jsxs6(DropdownMenu, { open: columnsOpen, onOpenChange: handleColumnsOpenChange, children: [
        /* @__PURE__ */ jsx8(
          ConditionalTooltip,
          {
            showTooltip: isDisabled,
            content: t("dataGrid.columns.disabled"),
            children: /* @__PURE__ */ jsx8(DropdownMenu.Trigger, { asChild: true, disabled: isDisabled, children: /* @__PURE__ */ jsxs6(Button2, { size: "small", variant: "secondary", children: [
              hasChanged ? /* @__PURE__ */ jsx8(AdjustmentsDone, {}) : /* @__PURE__ */ jsx8(Adjustments, {}),
              t("dataGrid.columns.view")
            ] }) })
          }
        ),
        /* @__PURE__ */ jsx8(DropdownMenu.Content, { children: columnOptions.map((column, index) => {
    ...
    /* @__PURE__ */ jsxs6("div", { className: "flex items-center gap-x-2", children: [
      errorCount > 0 && /* @__PURE__ */ jsxs6(
        Button2,
        {
          ...
          children: [
            /* @__PURE__ */ jsx8(ExclamationCircle2, { className: "text-ui-fg-subtle" }),
            /* @__PURE__ */ jsx8("span", { children: t("dataGrid.errors.count", {
              count: errorCount
            }) })
          ]
        }
...
var DataGridCell = ({
  ...
  return /* @__PURE__ */ jsx8(
    "div",
    {
      ...
      tabIndex: -1,
      children: /* @__PURE__ */ jsxs6("div", { className: "relative h-full w-full", children: [
        flexRender(cell.column.columnDef.cell, {
          ...cell.getContext(),
          columnIndex,
          rowIndex
        }),
        isAnchor && /* @__PURE__ */ jsx8(
          "div",
          {
...
var DataGridSkeleton = ({
  ...
  return /* @__PURE__ */ jsxs7("div", { className: "bg-ui-bg-subtle size-full", children: [
    /* @__PURE__ */ jsx9("div", { className: "bg-ui-bg-base border-b p-4", children: /* @__PURE__ */ jsx9("div", { className: "bg-ui-button-neutral h-7 w-[116px] animate-pulse rounded-md" }) }),
    /* @__PURE__ */ jsxs7("div", { className: "bg-ui-bg-subtle size-full overflow-auto", children: [
      /* @__PURE__ */ jsx9(
        "div",
        {
          className: "grid",
          ...
          children: columns.map((_col, i) => {
            return /* @__PURE__ */ jsx9(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsx9(Skeleton, { className: "h-[14px] w-[164px]" })
              },
              i
            );
          })
      ...
      /* @__PURE__ */ jsx9("div", { children: rows.map((_, j) => /* @__PURE__ */ jsx9(
        "div",
        {
          className: "grid",
...
import { Tooltip as Tooltip3, clx as clx6 } from "@medusajs/ui";
...
var IncludesTaxTooltip = ({
  ...
  return /* @__PURE__ */ jsx12(
    Tooltip3,
    {
      ...
      children: /* @__PURE__ */ jsx12(BuildingTax, { className: clx6({ "text-ui-fg-muted": !includesTax }) })
    }
  );
};
