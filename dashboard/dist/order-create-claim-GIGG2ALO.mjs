  ...
  return useMemo(
    () => [
      ...
      columnHelper.display({
        ...
        cell: ({ row }) => /* @__PURE__ */ jsx(ProductCell, { product: row.original.variant.product })
      }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-x-2 gap-y-2 border-b p-3 text-sm md:flex-row", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-1 items-center gap-x-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
          ...
          /* @__PURE__ */ jsx3(Text, { as: "div", className: "text-ui-fg-subtle txt-small", children: item.variant?.product?.title })
        ] })
      ] }),
...
var ClaimCreateForm = ({
  ...
  return /* @__PURE__ */ jsx8(RouteFocusModal.Form, { form, children: /* @__PURE__ */ jsxs4("form", { onSubmit: handleSubmit, className: "flex h-full flex-col", children: [
