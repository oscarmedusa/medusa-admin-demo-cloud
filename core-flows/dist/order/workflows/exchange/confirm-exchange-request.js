...
exports.confirmExchangeRequestWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.confirmExchangeRequestWorkflowId, function (input) {
    ...
    (0, confirm_order_changes_1.confirmOrderChanges)({ changes: [orderChange], orderId: order.id });
    ...
    const exchangeId = (0, workflows_sdk_1.transform)({ createdExchangeItems }, ({ createdExchangeItems }) => {
